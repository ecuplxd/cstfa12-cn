...
\input{../output/6_the_common_package/code/6_3_0_0.tex}

% dom\_tokens.ts defines the
% \texttt{DOCUMENT}
% const (note the important comment):

\input{../output/6_the_common_package/code/6_3_0_1.tex}

% The platform\_id.ts file contains these simple functions to determine which platform is
% in use:

\input{../output/6_the_common_package/code/6_3_0_2.tex}
