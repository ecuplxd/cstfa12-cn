...
\input{8_the_platform_browser_package/code/8_3_2_0.tex}

% For example, to check if shadow DOM is supported, it evaluates whether the
% \texttt{createShadowRoot}
% function exists:

\input{8_the_platform_browser_package/code/8_3_2_1.tex}
...
\input{8_the_platform_browser_package/code/8_3_2_2.tex}

% Generally its methods provide implementation based on window or document – here
% are some samples:

\input{8_the_platform_browser_package/code/8_3_2_3.tex}

% title.ts supplies the
% \texttt{Title}
% service:

\input{8_the_platform_browser_package/code/8_3_2_4.tex}
...
\input{8_the_platform_browser_package/code/8_3_2_5.tex}
...
\input{8_the_platform_browser_package/code/8_3_2_6.tex}
...
\input{8_the_platform_browser_package/code/8_3_2_7.tex}

% This manages two private fields, location and history:

\input{8_the_platform_browser_package/code/8_3_2_8.tex}
...
\input{8_the_platform_browser_package/code/8_3_2_9.tex}

% history.ts contains this simple function:

\input{8_the_platform_browser_package/code/8_3_2_10.tex}
