...
\input{../output/8_the_platform_browser_package/code/8_3_3_0.tex}
...
\input{../output/8_the_platform_browser_package/code/8_3_3_1.tex}

% In dom\_sanitization\_service.ts the safe marker interfaces are declared as:

\input{../output/8_the_platform_browser_package/code/8_3_3_2.tex}
...
\input{../output/8_the_platform_browser_package/code/8_3_3_3.tex}

% The
% \texttt{DomSanitizerImpl}
% injectable class is what is supplied to NgModule:

\input{../output/8_the_platform_browser_package/code/8_3_3_4.tex}
...
\input{../output/8_the_platform_browser_package/code/8_3_3_5.tex}
...
\input{../output/8_the_platform_browser_package/code/8_3_3_6.tex}
...
\input{../output/8_the_platform_browser_package/code/8_3_3_7.tex}
