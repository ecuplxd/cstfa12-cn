...
\input{../output/14_render_ivy_in_angular/code/14_2_0_0.tex}
...
\input{../output/14_render_ivy_in_angular/code/14_2_0_1.tex}

% and in tsconfig.app.json,
% \texttt{angularCompilerOptions}
% has this entry:

\input{../output/14_render_ivy_in_angular/code/14_2_0_2.tex}
