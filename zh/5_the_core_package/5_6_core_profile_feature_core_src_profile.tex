...
\input{../output/5_the_core_package/code/5_6_0.tex}

% It maintains two variables:

\input{../output/5_the_core_package/code/5_6_1.tex}

% It defines some functions to work with those variables:

\input{../output/5_the_core_package/code/5_6_2.tex}

% Finally it has a
% \texttt{detectWtf}
% function:

\input{../output/5_the_core_package/code/5_6_3.tex}

% The profile.ts file exports WTF-related variables:

\input{../output/5_the_core_package/code/5_6_4.tex}
