...
\input{../output/5_the_core_package/code/5_4_0.tex}
...
\input{../output/5_the_core_package/code/5_4_1.tex}

% metadata.ts also defines these variables:

\input{../output/5_the_core_package/code/5_4_2.tex}
...
\input{../output/5_the_core_package/code/5_4_3.tex}

% The injector.ts file defines the
% \texttt{Injector}
% abstract class:

\input{../output/5_the_core_package/code/5_4_4.tex}
...
\input{../output/5_the_core_package/code/5_4_5.tex}
