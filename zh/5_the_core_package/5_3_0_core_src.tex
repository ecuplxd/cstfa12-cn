...
\input{../output/5_the_core_package/code/5_3_0_0.tex}

% and zone.ts file is a one-liner that just exports from zone/ng\_zone.ts:

\input{../output/5_the_core_package/code/5_3_0_1.tex}
...
\input{../output/5_the_core_package/code/5_3_0_2.tex}
...
\input{../output/5_the_core_package/code/5_3_0_3.tex}

% It also defines the
% \texttt{platformCore}
% const, used when creating platforms:

\input{../output/5_the_core_package/code/5_3_0_4.tex}

% security.ts defines the
% \texttt{SecurityContext}
% enum:

\input{../output/5_the_core_package/code/5_3_0_5.tex}

% and the
% \texttt{Sanitizer}
% abstract class:

\input{../output/5_the_core_package/code/5_3_0_6.tex}
...
\input{../output/5_the_core_package/code/5_3_0_7.tex}
...
\input{../output/5_the_core_package/code/5_3_0_8.tex}
...
\input{../output/5_the_core_package/code/5_3_0_9.tex}
...
\input{../output/5_the_core_package/code/5_3_0_10.tex}
...
\input{../output/5_the_core_package/code/5_3_0_11.tex}

% application\_init.ts defines one opaque token and one injectable service. The opaque
% token is:

\input{../output/5_the_core_package/code/5_3_0_12.tex}
...
\input{../output/5_the_core_package/code/5_3_0_13.tex}
...
\input{../output/5_the_core_package/code/5_3_0_14.tex}
...
\input{../output/5_the_core_package/code/5_3_0_15.tex}
...
\input{../output/5_the_core_package/code/5_3_0_16.tex}
...
\input{../output/5_the_core_package/code/5_3_0_17.tex}
...
\input{../output/5_the_core_package/code/5_3_0_18.tex}

% It is in
% \texttt{\_moduleDoBootstrap}
% that we see the actual bootstrapping taking place:

\input{../output/5_the_core_package/code/5_3_0_19.tex}
...
\input{../output/5_the_core_package/code/5_3_0_20.tex}

% Only a single platform may be active at any one time.
% \texttt{\_platform}
% is defined as:

\input{../output/5_the_core_package/code/5_3_0_21.tex}

% The
% \texttt{getPlatform()}
% function is simply defined as:

\input{../output/5_the_core_package/code/5_3_0_22.tex}
...
\input{../output/5_the_core_package/code/5_3_0_23.tex}
...
\input{../output/5_the_core_package/code/5_3_0_27.tex}

% \texttt{ApplicationRef}
% is defined as:

\input{../output/5_the_core_package/code/5_3_0_28.tex}
...
\input{../output/5_the_core_package/code/5_3_0_31.tex}

% \texttt{\_loadComponent()}
% is defined as:

\input{../output/5_the_core_package/code/5_3_0_32.tex}
...
\input{../output/5_the_core_package/code/5_3_0_33.tex}
