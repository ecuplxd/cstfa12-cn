...
\input{../output/5_the_core_package/code/5_7_0.tex}

% The reflection.ts file has these lines:

\input{../output/5_the_core_package/code/5_7_1.tex}

% The platform\_reflection\_capabilities.ts file defines this interface:

\input{../output/5_the_core_package/code/5_7_2.tex}
...
\input{../output/5_the_core_package/code/5_7_3.tex}
