...
\input{../output/11_the_platform_webworker_package/code/11_1_0.tex}

% and public\_api.ts has this content:

\input{../output/11_the_platform_webworker_package/code/11_1_1.tex}

% The src/platform-webworker.ts file lists the various exports and defines the
% \texttt{bootstrapWorkerUi}
% function:

\input{../output/11_the_platform_webworker_package/code/11_1_2.tex}
