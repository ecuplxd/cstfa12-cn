...
\input{8_the_platform_browser_package/code/8_1_0.tex}

and this in turn has:

\input{8_the_platform_browser_package/code/8_1_1.tex}

If we look at src/platform-browser.ts, we see the exported API of the Platform-
Browser package:

\input{8_the_platform_browser_package/code/8_1_2.tex}
...
\input{8_the_platform_browser_package/code/8_1_3.tex}
