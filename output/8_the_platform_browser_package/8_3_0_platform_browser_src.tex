...
\input{8_the_platform_browser_package/code/8_3_0_0.tex}

Sanitization providers mitigate XSS risks – note the comment:

\input{8_the_platform_browser_package/code/8_3_0_1.tex}

It is used in the definition of
\texttt{BROWSER\_MODULE\_PROVIDERS}
:

\input{8_the_platform_browser_package/code/8_3_0_2.tex}

This in turn is used in the definition of
\texttt{BrowserModule}
:

\input{8_the_platform_browser_package/code/8_3_0_3.tex}
...
\input{8_the_platform_browser_package/code/8_3_0_4.tex}

As we saw, this function is used in an initializer by the app provider list:

\input{8_the_platform_browser_package/code/8_3_0_5.tex}

This in turn is used by the call to
\texttt{createPlatformFactory}
:

\input{8_the_platform_browser_package/code/8_3_0_6.tex}
