...
\input{9_the_platform_browser_dynamic_package/code/9_1_0.tex}

and the public\_api.ts file has these lines:

\input{9_the_platform_browser_dynamic_package/code/9_1_1.tex}
...
\input{9_the_platform_browser_dynamic_package/code/9_1_2.tex}
...
\input{9_the_platform_browser_dynamic_package/code/9_1_3.tex}
