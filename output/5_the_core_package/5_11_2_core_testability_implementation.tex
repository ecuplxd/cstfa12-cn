...
\input{5_the_core_package/code/5_11_2_0.tex}

\texttt{setTestabilityGetter}
is used to set the getter:

\input{5_the_core_package/code/5_11_2_1.tex}
...
\input{5_the_core_package/code/5_11_2_2.tex}

The
\texttt{Testability}
class is structured as follows:

\input{5_the_core_package/code/5_11_2_3.tex}
